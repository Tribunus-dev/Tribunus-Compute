...
impl StepAudio2 {
    ...
    fn build_asr_prompt(&self, audio_len: i32) -> (Vec<i32>, usize) {
        ...
        // Position where audio features will be inserted
        let audio_insert_pos = prompt.len();

        // Add placeholder tokens for audio length
    ...
    /// Build prompt for speech-to-speech
    #[cfg(feature = "tts")]
    ...
    fn generate_with_think(
        ...
        let max_total_tokens = handler.current_max_tokens() * 2;
